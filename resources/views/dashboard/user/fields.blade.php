...
<div class="form-group">
    ...
    {{ Form::select('wish_day',['Saturday','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday'],null , array_merge(['class' => 'form-control  '.($errors->has('wish_day') ? 'is-invalid' : '')],['required'=>true])) }}
    <x-dashboard.error name="wish_day"/>
</div>

<div class="form-group">
    {{ Form::label(__('main.start_time'), null, ['class' => 'control-label']) }}
    {{ Form::time('start_time', old('start_time'), array_merge(['class' => 'form-control  '.($errors->has('start_time') ? 'is-invalid' : '')],['required'=>true])) }}
    <x-dashboard.error name="start_time"/>
</div>

<div class="form-group">
    {{ Form::label(__('main.end_time'), null, ['class' => 'control-label']) }}
    {{ Form::time('end_time', old('end_time'), array_merge(['class' => 'form-control  '.($errors->has('end_time') ? 'is-invalid' : '')],['required'=>true])) }}
